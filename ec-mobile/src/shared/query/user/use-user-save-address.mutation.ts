...
export const useUserSaveAddress = (options?: Parameters<OpenapiQueryClient<'post', '/user/address'>['useMutation']>['2']) => {
      // @ts-ignore
    return apiClient.useMutation('post', '/user/address' as const, options)
  }
