...
export const useUserUpdateAddress = (options?: Parameters<OpenapiQueryClient<'patch', '/user/addresses/{id}'>['useMutation']>['2']) => {
      // @ts-ignore
    return apiClient.useMutation('patch', '/user/addresses/{id}' as const, options)
  }
