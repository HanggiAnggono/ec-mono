...
export const useUserDeleteAddress = (options?: Parameters<OpenapiQueryClient<'delete', '/user/addresses/{id}'>['useMutation']>['2']) => {
      // @ts-ignore
    return apiClient.useMutation('delete', '/user/addresses/{id}' as const, options)
  }
