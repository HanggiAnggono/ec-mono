...
export const useCartCheckoutCart = (options?: Parameters<OpenapiQueryClient<'post', '/cart/checkout'>['useMutation']>['2']) => {
      // @ts-ignore
    return apiClient.useMutation('post', '/cart/checkout' as const, options)
  }
